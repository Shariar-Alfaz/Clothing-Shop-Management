...
namespace ClothingShopManagementSystem.Data
{
    public class DataAccess
    {
        ...
        public DataAccess()
        {
            this.Sqlcon = new SqlConnection(@"Data Source=DESKTOP-FQLC4LF;Initial Catalog=ClothingShopManagementSystem1;
                                               Persist Security Info=True;User ID=sa;Password=p@s$word");
            this.Sqlcon.Open();
        }
