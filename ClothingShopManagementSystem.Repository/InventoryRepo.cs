...
namespace ClothingShopManagementSystem.Repository
{
     public class InventoryRepo
    {
        ...
        public List<Products> GetProduct(string nameOrCode)
        {
            var sql = "select* from products where(name like '%" + nameOrCode + "%' or productCode like '%" + nameOrCode + "%' or category like'%"+nameOrCode+"%' ) and quantity != 0; ";
